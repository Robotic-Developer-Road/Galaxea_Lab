...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p scripts/galaxea/demos/spawn_robot.py
...
# Pre-defined configs
##
# from isaaclab_assets.robots import GALAXEA_R1_CFG
from galaxea.assets.config.galaxea_robots import GALAXEA_R1_CFG
