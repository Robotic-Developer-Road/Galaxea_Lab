...
BOX_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/box/box.usd",
        scale=(0.6, 6.0, 0.6),
...
DEX_CUBE_CFG = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Object",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/block/DexCube/dex_cube_instanceable.usd",
        scale=(0.6, 6.0, 0.6),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
MULTI_COLOR_CUBE_CFG = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Object",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/block/MultiColorCube/multi_color_cube_instanceable.usd",
        scale=(0.6, 6.0, 0.6),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
T_CFG = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Object",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/block/T/t_block.usd",
        scale=(0.6, 6.0, 0.6),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
KLT_BIN_CFG: RigidObjectCfg = RigidObjectCfg(
    prim_path="/World/envs/env_.*/Object",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/KLT_Bin/small_KLT.usd",
        scale=(1.0, 1.0, 1.0),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
BASKET_CFG = RigidObjectCfg(
    ...
    debug_vis=True,
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/fruits/basket.usd",
        scale=(0.3, 0.3, 0.3),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
BIGYM_TABLE_CFG: AssetBaseCfg = AssetBaseCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/table/table.usd",
    ),
...
OAK_TABLE_CFG: AssetBaseCfg = AssetBaseCfg(
    prim_path="/World/envs/env_.*/Table",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/table/OakTableLarge.usd",
...
LOW_FULL_DESK_CFG: AssetBaseCfg = AssetBaseCfg(
    prim_path="/World/envs/env_.*/Table",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/table/LowFullDesk.usd",
...
CARROT_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"{usd_dir_path}/Props/fruits/carrot.usd",
        scale=(1.0, 1.0, 1.0),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
BANANA_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        # usd_path=f"/home/user/zhr_workspace/IsaacsimAsset/objects/fruits/fruit_v2/banana.usd",
        usd_path=f"{usd_dir_path}/Props/fruits/banana.usd",
        scale=(1.0, 1.0, 1.0),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            solver_position_iteration_count=16,
            solver_velocity_iteration_count=1,
...
TABLE_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        # usd_path=f"{usd_dir_path}/Props/table/OakTableLarge.usd",
        # usd_path=f"{usd_dir_path}/Props/table/LowFullDesk.usd",
        usd_path=f"{usd_dir_path}/Props/table/desk.usd",
        scale=(0.01, 0.01, 0.0135),
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
...
SEKTION_CABINET_CFG: AssetBaseCfg = AssetBaseCfg(
    prim_path="/World/envs/env_.*/Table",
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{usd_dir_path}/Props/Sektion_Cabinet/sektion_cabinet_instanceable.usd",
        scale=(1.0, 2.0, 1.2),
    ),
    init_state=AssetBaseCfg.InitialStateCfg(
        pos=(0.55, 0.0, 0.5),
