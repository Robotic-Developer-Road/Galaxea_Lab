...
from galaxea.tasks.manager_based.lift import mdp
from galaxea.tasks.manager_based.lift.lift_env_cfg import LiftEnvCfg
...
from galaxea.assets.config.galaxea_robots import (
    usd_dir_path,
    GALAXEA_R1_HIGH_PD_CFG,
    GALAXEA_R1_HIGH_PD_GRIPPER_CFG,
    GALAXEA_CAMERA_CFG,
)
from galaxea.assets.config.galaxea_assets import (
    DEX_CUBE_CFG,
    KLT_BIN_CFG,
...
class R1LiftCubeEnvCfg(R1LiftEnvCfg):
    def __post_init__(self):
        ...
        # self.scene.extras["table"] = XFormPrim(
